...
ResultCode
NetlinkProtocolSocket::addRoute(const rnl::Route& route) {
  auto rtmMsg = std::make_unique<rnl::NetlinkRouteMessage>();
  std::vector<folly::Future<int>> futures;
...
ResultCode
NetlinkProtocolSocket::addRoutes(const std::vector<rnl::Route> routes) {
  std::vector<std::unique_ptr<NetlinkMessage>> msg;
  std::vector<folly::Future<int>> futures;
...
ResultCode
NetlinkProtocolSocket::deleteRoute(const rnl::Route& route) {
  auto rtmMsg = std::make_unique<rnl::NetlinkRouteMessage>();
  std::vector<folly::Future<int>> futures;
  futures.emplace_back(rtmMsg->getFuture());
  ResultCode status{ResultCode::SUCCESS};
...
ResultCode
NetlinkProtocolSocket::addLabelRoute(const rnl::Route& route) {
  auto rtmMsg = std::make_unique<rnl::NetlinkRouteMessage>();
  std::vector<folly::Future<int>> futures;
  futures.emplace_back(rtmMsg->getFuture());
  ResultCode status{ResultCode::SUCCESS};
...
ResultCode
NetlinkProtocolSocket::deleteLabelRoute(const rnl::Route& route) {
  auto rtmMsg = std::make_unique<rnl::NetlinkRouteMessage>();
  std::vector<folly::Future<int>> futures;
  futures.emplace_back(rtmMsg->getFuture());
  ResultCode status{ResultCode::SUCCESS};
...
ResultCode
NetlinkProtocolSocket::addIfAddress(const rnl::IfAddress& ifAddr) {
  auto addrMsg = std::make_unique<rnl::NetlinkAddrMessage>();
  std::vector<folly::Future<int>> futures;
...
ResultCode
NetlinkProtocolSocket::deleteIfAddress(const rnl::IfAddress& ifAddr) {
  auto addrMsg = std::make_unique<rnl::NetlinkAddrMessage>();
  std::vector<folly::Future<int>> futures;
  futures.emplace_back(addrMsg->getFuture());
...
NetlinkProtocolSocket::getAllLinks() {
  ...
  auto linkMsg = std::make_unique<rnl::NetlinkLinkMessage>();
  std::vector<folly::Future<int>> futures;
...
NetlinkProtocolSocket::getAllNeighbors() {
  ...
  auto neighMsg = std::make_unique<rnl::NetlinkNeighborMessage>();
  std::vector<folly::Future<int>> futures;
...
NetlinkProtocolSocket::getAllRoutes() {
  routeCache_.clear();
  auto routeMsg = std::make_unique<rnl::NetlinkRouteMessage>();
  std::vector<folly::Future<int>> futures;
