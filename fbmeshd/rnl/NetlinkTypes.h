...
class NextHopBuilder final {
 public:
  ...
  NextHopBuilder& setLabelAction(fbmeshd::thrift::MplsActionCode);
  ...
  folly::Optional<fbmeshd::thrift::MplsActionCode> getLabelAction()
      const;
 ...
 private:
  ...
  folly::Optional<fbmeshd::thrift::MplsActionCode> labelAction_;
...
struct NextHopHash {
  size_t operator()(const rnl::NextHop& nh) const;
};
